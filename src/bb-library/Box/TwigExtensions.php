...
class Box_TwigExtensions extends AbstractExtension implements \Box\InjectionAwareInterface
{
    protected $di;
    ...
    {
        return array(
            'alink'     => new TwigFilter('alink', array($this, 'twig_bb_admin_link_filter'), array('is_safe' => array('html'))),
            'link'      => new TwigFilter('link', array($this, 'twig_bb_client_link_filter'), array('is_safe' => array('html'))),
            'gravatar'  => new TwigFilter('gravatar', array($this, 'twig_gravatar_filter')),
            'markdown'  => new TwigFilter('markdown', array($this, 'twig_markdown_filter'), array('needs_environment' => true, 'is_safe' => array('html'))),
            'truncate'  => new TwigFilter('truncate', array($this, 'twig_truncate_filter'), array('needs_environment' => true)),
            'timeago'   => new TwigFilter('timeago', array($this, 'twig_timeago_filter')),
            'daysleft'  => new TwigFilter('daysleft', array($this, 'twig_daysleft_filter')),
            'size'      => new TwigFilter('size', array($this, 'twig_size_filter')),
            'ipcountryname' => new TwigFilter('ipcountryname', array($this, 'twig_ipcountryname_filter')),
            'number' => new TwigFilter('number', array($this, 'twig_number_filter')),
            'period_title' => new TwigFilter('period_title', array($this, 'twig_period_title'), array('needs_environment' => true, 'is_safe' => array('html'))),
            'autolink' => new TwigFilter('autolink', array($this, 'twig_autolink_filter')),
            'bbmd' => new TwigFilter('bbmd', array($this, 'twig_bbmd_filter'), array('needs_environment' => true, 'is_safe' => array('html'))),

            'bb_date' => new TwigFilter('bb_date', array($this, 'twig_bb_date')),
            'bb_datetime' => new TwigFilter('bb_datetime', array($this, 'twig_bb_datetime')),

            'img_tag' => new TwigFilter('img_tag', array($this, 'twig_img_tag'), array('needs_environment' => false, 'is_safe' => array('html'))),
            'script_tag' => new TwigFilter('script_tag', array($this, 'twig_script_tag'), array('needs_environment' => false, 'is_safe' => array('html'))),
            'stylesheet_tag' => new TwigFilter('stylesheet_tag', array($this, 'twig_stylesheet_tag'), array('needs_environment' => false, 'is_safe' => array('html'))),

            'mod_asset_url' => new TwigFilter('mod_asset_url', array($this, 'twig_mod_asset_url')),
            'asset_url' => new TwigFilter('asset_url', array($this, 'twig_asset_url'), array('needs_environment' => true, 'is_safe' => array('html'))),

            'money' => new TwigFilter('money', array($this, 'twig_money'), array('needs_environment' => true, 'is_safe' => array('html'))),
            'money_without_currency' => new TwigFilter('money_without_currency', array($this, 'twig_money_without_currency'), array('needs_environment' => true, 'is_safe' => array('html'))),
            'money_convert' => new TwigFilter('money_convert', array($this, 'twig_money_convert'), array('needs_environment' => true, 'is_safe' => array('html'))),
            'money_convert_without_currency' => new TwigFilter('money_convert_without_currency', array($this, 'money_convert_without_currency'), array('needs_environment' => true, 'is_safe' => array('html'))),
        );
    }
    ...
    function twig_asset_url(Twig_Environment $env, $asset)
    {
        ...
        return BB_URL . 'bb-themes/'.$code.'/assets/'.$asset;
    }
